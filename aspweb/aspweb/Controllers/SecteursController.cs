...
namespace aspweb.Controllers
{
    public class SecteursController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "codeSecteur,nomSecteur")] Secteur secteur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "codeSecteur,nomSecteur")] Secteur secteur)
        {
            if (ModelState.IsValid)
            {
